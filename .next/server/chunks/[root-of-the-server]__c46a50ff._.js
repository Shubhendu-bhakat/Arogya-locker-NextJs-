module.exports = [
"[project]/.next-internal/server/app/api/auth/documents/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/auth/documents/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next-auth/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/auth/[...nextauth]/route.ts [app-route] (ecmascript)"); // import correct auth config
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/prisma.ts [app-route] (ecmascript)");
;
;
;
...
async function GET(req) {
    ...
    try {
        ...
        // Fetch documents
        const documents = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findMany({
            where: whereClause,
            orderBy: {
                createdAt: "desc"
            },
        ...
        // Get category counts
        const categoryCounts = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.groupBy({
            by: [
                "category"
            ],
            where: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            details: ("TURBOPACK compile-time truthy", 1) ? error instanceof Error ? error.message : "Unknown error" : "TURBOPACK unreachable"
        }, {
            status: 500
        });
    }
    function logRequest(req, statusCode, startTime) {
        ...
        console.log(`[${req.method}] ${req.url} - Status: ${statusCode} - Time: ${duration}ms`);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__c46a50ff._.js.map