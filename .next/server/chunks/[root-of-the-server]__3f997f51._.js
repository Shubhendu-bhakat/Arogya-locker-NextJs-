module.exports = [
"[project]/.next-internal/server/app/api/auth/documents/uploades/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/auth/documents/uploades/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const baseName = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(file.name, ext).replace(/[^a-zA-Z0-9_-]/g, "_");
        const s3FileName = `documents/${userId}/${category.toLowerCase()}/${timestamp}-${baseName}${ext}`;
        // ✅ Create document record with UPLOADING status
        const document = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.create({
            data: {
                name: file.name,
                fileName: s3FileName,
                url: "",
        ...
        try {
            ...
            const updatedDocument = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.update({
                where: {
                    id: document.id
                },
                data: {
            ...
            // Mark as FAILED
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.update({
                where: {
                    id: document.id
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f997f51._.js.map